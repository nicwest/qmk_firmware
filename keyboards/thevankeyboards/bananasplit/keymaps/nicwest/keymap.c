...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QW] = LAYOUT_all(
        ...
        KC_LCTL,  MO(_ME), KC_LALT,                   KC_SPC,   KC_LGUI, KC_BSPC,                   KC_DEL,  KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT
    ),
    [_WO] = LAYOUT_all(
        KC_GRAVE, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,     KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_HOME, KC_INSERT,
        KC_TAB,   KC_Q,    KC_D,    KC_R,    KC_W,    KC_B,     KC_J,    KC_F,    KC_U,    KC_P,    KC_SCLN, KC_LBRC, KC_RBRC,          KC_ENT,
        KC_ESC,   KC_A,    KC_S,    KC_H,    KC_T,    KC_G,     KC_Y,    KC_N,    KC_E,    KC_O,    KC_I,    KC_QUOT, KC_NUHS, 
        KC_LSFT,  KC_NUBS, KC_Z,    KC_X,    KC_M,    KC_C,     KC_V,    KC_K,    KC_L,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, XXXXXXX,
        KC_LCTL,  MO(_ME), KC_LALT,                   KC_SPC,   KC_LGUI, KC_BSPC,                   KC_DEL,  KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT
    ),
    [_DV] = LAYOUT_all(
        KC_GRAVE, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,     KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_LBRC, KC_RBRC, KC_HOME, KC_INSERT,
        KC_TAB,   KC_QUOT, KC_COMM, KC_DOT,  KC_P,    KC_Y,     KC_F,    KC_G,    KC_C,    KC_R,    KC_L,    KC_SLSH, KC_EQL,           KC_ENT,
        KC_ESC,   KC_A,    KC_O,    KC_E,    KC_U,    KC_I,     KC_D,    KC_H,    KC_T,    KC_N,    KC_S,    KC_MINS, KC_NUHS, 
        KC_LSFT,  KC_SCLN, KC_Q,    KC_J,    KC_K,    KC_X,     KC_B,    KC_M,    KC_W,    KC_V,    KC_Z,    KC_NUBS, KC_RSFT, XXXXXXX,
        KC_LCTL,  MO(_ME), KC_LALT,                   KC_SPC,   KC_LGUI, KC_BSPC,                   KC_DEL,  KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT
    ),
    [_ME] = LAYOUT_all(
        ...
        KC_CAPS,  _______, _______, _______, _______, _______,  KC_MNXT, KC_MPLY, KC_MUTE, KC_MPRV, _______, KC_BRID, KC_BRIU, 
        _______,  _______, _______, _______, _______, _______,  _______, _______, _______, _______, _______, _______, _______, _______,
        _______,  KC_NO,   _______,                   _______,  _______, _______,                   _______, _______, KC_PGDN, KC_PGUP, _______
    ),
    [_ST] = LAYOUT_all(
