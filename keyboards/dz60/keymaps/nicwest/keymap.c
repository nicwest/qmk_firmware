...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_DV] = LAYOUT(
        ...
        KC_LSFT,  KC_NUBS, KC_Q,    KC_J,    KC_K,    KC_X,     KC_B,    KC_M,    KC_W,    KC_V,    KC_Z,    KC_BSLS, KC_RSFT, XXXXXXX,
        KC_LCTL,  MO(_ME), KC_LALT,                   KC_SPC,   KC_LGUI, KC_BSPC,                   KC_DEL, KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT
    ),
    [_ME] = LAYOUT(
        ...
        _______,  KC_NO,   _______,                   RGB_TOG,  _______, _______,                    _______, _______, KC_PGDN, KC_PGUP, _______
    ),
    [_ST] = LAYOUT(
